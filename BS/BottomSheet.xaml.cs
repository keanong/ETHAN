...
using global::Microsoft.Maui.Graphics;
...
public partial class BottomSheet : ContentView
{
    ...
    private void UpdateTheme()
    {
        ...
        MainContent.BackgroundColor = Color.FromArgb(Theme == DisplayTheme.Dark ? "#E1E1E1" : "#FFFFFF");
        MainContent.Stroke = Color.FromArgb(Theme == DisplayTheme.Dark ? "#E1E1E1" : "#FFFFFF");
    }
    ...
    public BottomSheet()
    {
        ...
        CloseBottomSheetButton.Source = "icnmenuclose.png";
    }

    // Expose the HeaderLabel
    public Label headerLabel => this.HeaderLabel;

    public async Task OpenBottomSheet(bool showclose = true, bool whiteTitle = false, bool grayBG = false)
    {
        this.InputTransparent = false;
        BackgroundFader.IsVisible = true;
        //CloseBottomSheetButton.IsVisible = true;
        CloseBottomSheetButton.IsVisible = showclose;
        HeaderLabel.TextColor = whiteTitle ? Colors.White : Colors.Black;
